...
export const metadata: Metadata = {
  ...
  description: "How Sensybull collects, uses and protects your information.",
  ...
  return (
    <div className="min-h-screen bg-canvas">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-4xl">
        <div className="mb-12">
          <h1 className="mb-4 text-display font-semibold text-ink">
            Privacy Policy
          </h1>
          <p className="text-ink-faint">Last updated: December 8, 2025</p>
        </div>
        ...
        <div className="max-w-none">
          ...
          <section className="mb-12">
            <h2 className="mb-5 text-heading font-semibold text-ink">I. Information We Collect</h2>
            ...
            <p className="leading-relaxed text-ink-muted mb-4">
              <strong className="text-ink">Non-Personal Information</strong> includes information
            ...
            <p className="leading-relaxed text-ink-muted mb-6">
              <strong className="text-ink">Personal Information</strong> includes your email address,
              name, and account preferences, which you submit to us through the registration process at
              the Site.
            </p>

            <div className="mb-6 border-l-2 border-line pl-6">
              ...
              <p className="mb-3 leading-relaxed text-ink-muted">
                ...
                view or use the Service, such as the website you came from (known as the &quot;referring
              ...
              <ul className="mb-3 ml-4 list-inside list-disc space-y-2 text-ink-muted">
            ...
            <div className="mb-6 border-l-2 border-line pl-6">
              ...
              <p className="leading-relaxed text-ink-muted">
                ...
                creating a user name and a password, and optionally providing your name. By registering,
                you are authorizing us to collect, store and use your email address in accordance with
                this Privacy Policy.
              </p>
            </div>
            ...
            <div className="border-l-2 border-line pl-6">
              ...
              <p className="leading-relaxed text-ink-muted">
                ...
                we have gathered personal information from anyone under the age of 18 without the consent
                of a parent or guardian, we will delete that information as soon as possible. If you
          ...
          <section className="mb-12">
            ...
            <div className="mb-6">
              <h3 className="mb-2 text-title font-medium text-ink">Personal Information</h3>
              <p className="mb-3 leading-relaxed text-ink-muted">
              ...
              <p className="leading-relaxed text-ink-muted">
                ...
                fraud, security or technical concerns; or to protect against harm to the rights,
                property, or safety of our users or the public as required or permitted by law.
              </p>
            </div>

            <div>
              <h3 className="mb-2 text-title font-medium text-ink">Non-Personal Information</h3>
              <p className="mb-3 leading-relaxed text-ink-muted">
              ...
              <p className="leading-relaxed text-ink-muted">
                ...
                continue to process your Personal Information as set forth in this Privacy Policy.
              </p>
            </div>
          </section>
          ...
          {/* Section III */}
          <section className="mb-12">
            <h2 className="mb-5 text-heading font-semibold text-ink">III. How We Protect Information</h2>
            <p className="mb-3 leading-relaxed text-ink-muted">
            ...
            <p className="leading-relaxed text-ink-muted">
              ...
              be accessed, disclosed, altered or destroyed by breach of such firewalls and secure server
              software. By using our Service, you acknowledge that you understand and agree to assume
              these risks.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="leading-relaxed text-ink-muted">
              ...
              Settings, we may continue to send you administrative emails including, for example,
          ...
          {/* Section V */}
          <section className="mb-12">
            <h2 className="mb-5 text-heading font-semibold text-ink">V. Links to Other Websites</h2>
            <p className="mb-3 leading-relaxed text-ink-muted">
            ...
            <p className="leading-relaxed text-ink-muted">
              ...
              of that other website or application will apply to your access or use of that site or
          ...
          {/* Section VI */}
          <section className="mb-12">
            <h2 className="mb-5 text-heading font-semibold text-ink">VI. Changes to Our Privacy Policy</h2>
            <p className="mb-3 leading-relaxed text-ink-muted">
          ...
          {/* Section VII */}
          <section className="mb-12 p-6 rounded-md border border-line-subtle bg-canvas-sunken">
            <h2 className="mb-5 text-heading font-semibold text-ink">VII. Contact Us</h2>
            <p className="leading-relaxed text-ink-muted mb-4">
