  ...
  return (
    <div className="min-h-screen bg-canvas">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-4xl">
        <div className="mb-12">
          <h1 className="mb-4 text-display font-semibold text-ink">Terms of Use</h1>
          <p className="mt-2 text-label text-ink-faint">Last revised: December 8, 2025</p>
        </div>

        <div className="max-w-none">
          {/* Introduction */}
          <div className="mb-8 p-6 rounded-md border border-line-subtle bg-canvas-sunken">
          ...
          {/* Important Notice */}
          <div className="mb-8 p-6 rounded-md border border-danger/30 bg-danger-soft">
            <p className="mb-4 font-semibold text-danger">
              IMPORTANT NOTICE REGARDING ARBITRATION
            </p>
            <p className="mb-3 text-label leading-relaxed text-ink-muted">
              PLEASE BE AWARE THAT SECTION 8.2 CONTAINS PROVISIONS GOVERNING HOW TO RESOLVE DISPUTES
              BETWEEN YOU AND COMPANY. AMONG OTHER THINGS, SECTION 8.2 INCLUDES AN AGREEMENT TO
              ARBITRATE WHICH REQUIRES, WITH LIMITED EXCEPTIONS, THAT ALL DISPUTES BETWEEN YOU AND US
              SHALL BE RESOLVED BY BINDING AND FINAL ARBITRATION. SECTION 8.2 ALSO CONTAINS A CLASS
              ACTION AND JURY TRIAL WAIVER. PLEASE READ SECTION 8.2 CAREFULLY.
            </p>
            <p className="text-label leading-relaxed text-ink-muted">
              ...
              AND (2) YOU ARE WAIVING YOUR RIGHT TO PURSUE DISPUTES OR CLAIMS AND SEEK RELIEF IN A COURT
          ...
          <section className="mb-12">
            <h2 className="mb-5 text-heading font-semibold text-ink">1. Accounts</h2>

            <div className="mb-6">
              <h3 className="mb-2 text-title font-medium text-ink">1.1 Account Creation</h3>
              <p className="leading-relaxed text-ink-muted">
                ...
                such information. You may delete your Account at any time, for any reason, by following
                the instructions on the Site. Company may suspend or terminate your Account in accordance
                with Section 7.
              </p>
            </div>

            <div className="mb-6">
              <h3 className="mb-2 text-title font-medium text-ink">
              ...
              <p className="leading-relaxed text-ink-muted">
                ...
                Account or any other breach of security. Company cannot and will not be liable for any
          ...
          <section className="mb-12">
            <h2 className="mb-5 text-heading font-semibold text-ink">2. Access to the Site</h2>

            <div className="mb-6">
              <h3 className="mb-2 text-title font-medium text-ink">2.1 License</h3>
              <p className="leading-relaxed text-ink-muted">
            ...
            <div className="mb-6">
              <h3 className="mb-2 text-title font-medium text-ink">2.2 Certain Restrictions</h3>
              <p className="mb-3 leading-relaxed text-ink-muted">
                The rights granted to you in these Terms are subject to the following restrictions:
              </p>
              <ul className="ml-4 list-inside list-disc space-y-2 text-ink-muted">
                <li>
                  You shall not license, sell, rent, lease, transfer, assign, distribute, host, or
                  otherwise commercially exploit the Site
                </li>
                <li>
                  You shall not modify, make derivative works of, disassemble, reverse compile or
            ...
            <div className="mb-6">
              <h3 className="mb-2 text-title font-medium text-ink">2.3 Modification</h3>
              <p className="leading-relaxed text-ink-muted">
            ...
            <div className="mb-6">
              <h3 className="mb-2 text-title font-medium text-ink">2.5 Ownership</h3>
              <p className="leading-relaxed text-ink-muted">
                ...
                you or any third party any rights, title or interest in or to such intellectual property
                rights, except for the limited access rights expressly set forth in Section 2.1.
              </p>
            </div>

            <div className="mb-6">
              <h3 className="mb-2 text-title font-medium text-ink">2.6 Feedback</h3>
              <p className="leading-relaxed text-ink-muted">
          ...
          <section className="mb-12">
            <h2 className="mb-5 text-heading font-semibold text-ink">3. Indemnification</h2>
            <p className="leading-relaxed text-ink-muted">
              ...
              (c) your violation of applicable laws or regulations. Company reserves the right, at your
          ...
          <section className="mb-12">
            <h2 className="mb-5 text-heading font-semibold text-ink">
            ...
            <div className="mb-6">
              ...
              <p className="leading-relaxed text-ink-muted">
                ...
                with respect to Third-Party Links &amp; Ads. You use all Third-Party Links &amp; Ads at
                your own risk, and should apply a suitable level of caution and discretion in doing so.
            ...
            <div className="mb-6">
              <h3 className="mb-2 text-title font-medium text-ink">4.2 Other Users</h3>
              <p className="leading-relaxed text-ink-muted">
            ...
            <div className="mb-6">
              <h3 className="mb-2 text-title font-medium text-ink">4.3 Release</h3>
              <p className="mb-3 leading-relaxed text-ink-muted">
                ...
                and property damage), that has arisen or arises directly or indirectly out of, or that
              ...
              <p className="rounded-md bg-canvas-sunken p-4 text-label leading-relaxed text-ink-muted">
          ...
          <section className="mb-12">
            <h2 className="mb-5 text-heading font-semibold text-ink">5. Disclaimers</h2>
            <div className="p-6 rounded-md border border-warning/30 bg-warning-soft">
              <p className="mb-3 text-label leading-relaxed text-ink-muted">
                ...
                ANY KIND, WHETHER EXPRESS, IMPLIED, OR STATUTORY, INCLUDING ALL WARRANTIES OR CONDITIONS
                OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, QUIET ENJOYMENT, ACCURACY,
                OR NON-INFRINGEMENT. WE (AND OUR SUPPLIERS) MAKE NO WARRANTY THAT THE SITE WILL MEET
          ...
          <section className="mb-12">
            <h2 className="mb-5 text-heading font-semibold text-ink">6. Limitation on Liability</h2>
            <div className="p-6 rounded-md border border-warning/30 bg-warning-soft space-y-4">
              <p className="text-label leading-relaxed text-ink-muted">
                ...
                USE, THE SITE, EVEN IF COMPANY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
          ...
          <section className="mb-12">
            <h2 className="mb-5 text-heading font-semibold text-ink">7. Term and Termination</h2>
            <p className="leading-relaxed text-ink-muted">
              ...
              and right to access and use the Site will terminate immediately. Company will not have any
              liability whatsoever to you for any termination of your rights under these Terms, including
              for termination of your Account. Even after your rights under these Terms are terminated,
              the following provisions of these Terms will remain in effect: Sections 2.2 through 2.6
              and Sections 3 through 8.
            </p>
          </section>

          {/* Section 8: General */}
          <section className="mb-12">
            <h2 className="mb-5 text-heading font-semibold text-ink">8. General</h2>

            <div className="mb-8">
              <h3 className="mb-2 text-title font-medium text-ink">8.1 Changes</h3>
              <p className="leading-relaxed text-ink-muted">
                ...
                responsible for providing us with your most current e-mail address. In the event that the
                ...
                described in the notice. Continued use of our Site following notice of such changes shall
            ...
            <div className="mb-8 p-6 rounded-md border border-danger/25 bg-danger-soft">
              ...
              <p className="leading-relaxed text-ink-muted mb-6">
                ...
                respective officers, directors, employees, agents, and representatives (collectively, the
              ...
              <div className="mb-6 border-l-2 border-danger pl-4">
                ...
                <p className="mb-3 leading-relaxed text-ink-muted">
                  ...
                  you and the Company Parties may assert individualized claims in small claims court if
                  the claims qualify, remain in such court and advance solely on an individual, non-class
                  basis; and (2) you or the Company Parties may seek equitable relief in court for
                ...
                <p className="mb-3 leading-relaxed text-ink-muted">
                  <strong>
                    ...
                    you agreed to these Terms or any prior version of these Terms.
                  </strong>{" "}
              ...
              <div className="mb-6 border-l-2 border-danger pl-4">
                ...
                <p className="mb-3 leading-relaxed text-ink-muted">
                  ...
                  prompt, low-cost and mutually beneficial outcome. You and Company therefore agree that
                ...
                <p className="mb-3 leading-relaxed text-ink-muted">
                  ...
                  extension is mutually agreed upon by the parties. Notice to Company that you intend to
                  initiate an Informal Dispute Resolution Conference should be sent by email to:
                ...
                <p className="leading-relaxed text-ink-muted">
                  ...
                  parties agree. Engaging in the Informal Dispute Resolution Conference is a condition
                  precedent and requirement that must be fulfilled before commencing arbitration. The
                  statute of limitations and any filing fee deadlines shall be tolled while the parties
              ...
              <div className="mb-6 border-l-2 border-danger pl-4">
                ...
                <p className="mb-3 leading-relaxed text-ink-muted">
                  ...
                  enforcement of this Arbitration Agreement and any arbitration proceedings. If the
                  Informal Dispute Resolution Process described above does not resolve satisfactorily
                ...
                <p className="mb-3 leading-relaxed text-ink-muted">
                  ...
                  the account username (if applicable) as well as the email address associated with any
                  applicable account; (2) a statement of the legal claims being asserted and the factual
                  bases of those claims; (3) a description of the remedy sought and an accurate,
                  good-faith calculation of the amount in controversy in United States Dollars; (4) a
                  statement certifying completion of the Informal Dispute Resolution process as described
              ...
              <div className="mb-6 border-l-2 border-danger pl-4">
                ...
                <p className="mb-3 leading-relaxed text-ink-muted">
                  ...
                  or any portion of the Arbitration Agreement, except for the following: (1) all Disputes
                  arising out of or relating to the subsection entitled &quot;Waiver of Class or Other
                  Non-Individualized Relief,&quot; including any claim that all or part of such subsection
                  is unenforceable, illegal, void or voidable, or that such subsection has been breached,
                  shall be decided by a court of competent jurisdiction and not by an arbitrator; (2)
                  except as expressly contemplated in the subsection entitled &quot;Batch
                  Arbitration,&quot; all Disputes about the payment of arbitration fees shall be decided
                  only by a court of competent jurisdiction and not by an arbitrator; (3) all Disputes
                  about whether either party has satisfied any condition precedent to arbitration shall be
                  decided only by a court of competent jurisdiction and not by an arbitrator; and (4) all
                ...
                <p className="leading-relaxed text-ink-muted">
                  ...
                  motions dispositive of all or part of any claim or dispute. The arbitrator shall have
                  the authority to award monetary damages and to grant any non-monetary remedy or relief
                  available to an individual party under applicable law, the arbitral forum&apos;s rules,
                  and these Terms (including the Arbitration Agreement). The arbitrator shall issue a
                  ...
                  upon you and us. Judgment on the arbitration award may be entered in any court having
                  jurisdiction.
                </p>
              </div>
              ...
              <div className="mb-6 border-l-2 border-danger pl-4">
                ...
                <p className="leading-relaxed text-ink-muted">
                  ...
                  claims and disputes shall be resolved exclusively by arbitration under this Arbitration
                  Agreement, except as specified in Section 8.2(a) above. An arbitrator can award on an
              ...
              <div className="mb-6 border-l-2 border-danger pl-4">
                ...
                <p className="leading-relaxed text-ink-muted">
                  ...
                  claim or request for relief (such as a request for public injunctive relief), you and
                  Company agree that that particular claim or request for relief (and only that particular
                  claim or request for relief) shall be severed from the arbitration and may be litigated
                  in the state or federal courts located in the State of New Jersey. All other Disputes
                  shall be arbitrated or litigated in small claims court. This subsection does not prevent
              ...
              <div className="mb-6 border-l-2 border-danger pl-4">
                ...
                <p className="leading-relaxed text-ink-muted">
                  ...
                  standards set forth in Federal Rule of Civil Procedure 11(b)). If you or Company need
                  to invoke the authority of a court of competent jurisdiction to compel arbitration, then
                  the party that obtains an order compelling arbitration in such action shall have the
                  right to collect from the other party its reasonable costs, necessary disbursements, and
                  reasonable attorneys&apos; fees incurred in securing an order compelling arbitration. The
                  prevailing party in any court action relating to whether either party has satisfied any
                  condition precedent to arbitration, including the Informal Dispute Resolution Process,
                  is entitled to recover their reasonable costs, necessary disbursements, and reasonable
              ...
              <div className="mb-6 border-l-2 border-danger pl-4">
                ...
                <p className="mb-3 leading-relaxed text-ink-muted">
                  ...
                  same law firm, group of law firms, or organizations, within a 30 day period (or as soon
                  as possible thereafter), the JAMS shall (1) administer the arbitration demands in
                  batches of 100 Requests per batch (plus, to the extent there are less than 100 Requests
                  left over after the batching described above, a final batch consisting of the remaining
                  ...
                  administrative fees due per side per batch, one procedural calendar, one hearing (if
                ...
                <p className="mb-3 leading-relaxed text-ink-muted">
                  ...
                  Administrative Arbitrator, the parties agree the Administrative Arbitrator may set forth
              ...
              <div className="mb-6 border-l-2 border-danger pl-4">
                ...
                <p className="leading-relaxed text-ink-muted">
                  ...
                  within 30 days after first becoming subject to this Arbitration Agreement. Your notice
                  must include your name and address and a clear statement that you want to opt out of
              ...
              <div className="mb-6 border-l-2 border-danger pl-4">
                ...
                <p className="leading-relaxed text-ink-muted">
                  ...
                  Arbitration Agreement shall continue in full force and effect. You further agree that
                  any Dispute that you have with Company as detailed in this Arbitration Agreement must be
                  ...
                  statutes of limitation will apply to such arbitration in the same manner as those
                  statutes of limitation would apply in the applicable court of competent jurisdiction.
                </p>
              </div>
              ...
              <div className="border-l-2 border-danger pl-4">
                ...
                <p className="leading-relaxed text-ink-muted">
                  ...
                  following address: 394 Baldwin Ave, Apt 1, Jersey City, New Jersey 07306, or email to
                  info@sensybull.com. Unless you reject the change within 30 days of such change becoming
                  effective by writing to Company in accordance with the foregoing, your continued use of
                  the Site and/or Services, including the acceptance of products and services offered on
                  the Site following the posting of changes to this Arbitration Agreement constitutes your
                  acceptance of any such changes. Changes to this Arbitration Agreement do not provide you
                  with a new opportunity to opt out of the Arbitration Agreement if you have previously
                  agreed to a version of these Terms and did not validly opt out of arbitration. If you
                  reject any change or update to this Arbitration Agreement, and you were bound by an
                  existing agreement to arbitrate Disputes arising out of or relating in any way to your
                  access to or use of the Services or of the Site, any communications you receive, any
                  products sold or distributed through the Site, the Services, or these Terms, the
                  provisions of this Arbitration Agreement as of the date you first accepted these Terms
                  (or accepted any subsequent changes to these Terms) remain in full force and effect.
                  Company will continue to honor any valid opt outs of the Arbitration Agreement that you
            ...
            <div className="mb-6">
              <h3 className="mb-2 text-title font-medium text-ink">8.3 Export</h3>
              <p className="leading-relaxed text-ink-muted">
            ...
            <div className="mb-6">
              <h3 className="mb-2 text-title font-medium text-ink">8.4 Disclosures</h3>
              <p className="leading-relaxed text-ink-muted">
            ...
            <div className="mb-6">
              <h3 className="mb-2 text-title font-medium text-ink">8.6 Entire Terms</h3>
              <p className="leading-relaxed text-ink-muted">
                ...
                any reason, held to be invalid or unenforceable, the other provisions of these Terms will
                be unimpaired and the invalid or unenforceable provision will be deemed modified so that
                it is valid and enforceable to the maximum extent permitted by law. Your relationship to
          ...
          <div className="mt-12 border-t border-line-subtle pt-8 text-center text-meta text-ink-faint">
