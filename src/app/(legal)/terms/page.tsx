...
export default function TermsOfService() {
  return (
    <div className="min-h-screen bg-white dark:bg-[#0b0d12]">
      <header className="border-b border-slate-200 dark:border-white/[0.06] bg-white/80 dark:bg-[#0b0d12]/80 backdrop-blur-sm sticky top-0 z-50">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-4xl">
        ...
        <div className="prose dark:prose-invert prose-slate max-w-none">
          {/* Introduction */}
          <div className="mb-8 p-6 bg-slate-100/50 dark:bg-[#14161c]/50 border border-slate-200 dark:border-white/[0.06] rounded-lg">
          ...
          <section className="mb-12">
            ...
            <div className="mb-6">
              ...
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-sm bg-slate-100/30 dark:bg-[#14161c]/30 p-4 rounded">
          ...
          <section className="mb-12">
            ...
            <div className="mb-6 p-6 bg-slate-100/50 dark:bg-[#14161c]/50 border border-slate-200 dark:border-white/[0.06] rounded-lg">
