    ...
    <div className="min-h-screen bg-white dark:bg-[#0b0d12]">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-4xl">
        ...
        <div className="prose dark:prose-invert prose-slate max-w-none">
          <div className="p-6 bg-slate-100/50 dark:bg-[#14161c]/50 border border-slate-200 dark:border-white/[0.06] rounded-lg">
            ...
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
              ...
              This is not investment advice, financial advice, trading advice, or any other sort of
            ...
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
              <strong>Do conduct your own due diligence</strong> and consult your licensed financial
              advisor before making any investment decisions. Past performance is not indicative of
              future results. Any investment in securities, including the securities mentioned on our
              website, may result in the loss of your capital.
            </p>
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              By using Sensybull, you acknowledge that you have read this disclaimer and agree to be
              bound by its terms.
            </p>
          </div>

          <section className="mt-12 p-6 bg-slate-100/50 dark:bg-[#14161c]/50 border border-slate-200 dark:border-white/[0.06] rounded-lg">
          ...
          <section className="mt-8 p-6 bg-slate-100/50 dark:bg-[#14161c]/50 border border-slate-200 dark:border-white/[0.06] rounded-lg">
